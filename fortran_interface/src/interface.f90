...
!  end interface
  ...
  interface new
    module procedure beam_bunch_new, beam_coasting_new
!        ions_montecarlo_new, beam_bunch_new, beam_coasting_new, c_lattice_new, c_ring_lattice_new, &
!        c_ring_new, c_cooler_new, c_force_solver_new
  end interface

  interface delete
    module procedure beam_delete
!        ion_delete, beam_delete, ring_delete, lattice_delete, cooler_delete, ebeam_delete, &
